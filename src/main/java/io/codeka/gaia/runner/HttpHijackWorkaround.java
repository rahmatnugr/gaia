...
//    /**
//     * Extract a WritableByteChannel from a docker LogStream, in order to be able to send characters to containers,
//     * mostly when attached to a container.
//     * @param stream the LogStream to hijack
//     * @param uri the docker host uri (hijacking does not work the same way with http and unix sockets)
